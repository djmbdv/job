                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <div class="footer-about-us">
                                ...
                                <p>somos una empresa de servicios de directorios online.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-5 mt-30-xs">
                            ...
                            <ul class="footer-menu clearfix">
                                ...
                                <li><a href="employers.php">servicios</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4">
                    <ul class="bottom-footer-menu">
                        <li><a >Desarrollado por mi</a></li>
                    </ul>
                </div>
                <div class="col-sm-4 col-md-4">
                    <ul class="bottom-footer-menu for-social">
                        <li><a href="<?php echo "#"; ?>"><i class="ri ri-twitter" data-toggle="tooltip" data-placement="top" title="twitter"></i></a></li>
                        <li><a href="<?php echo "#"; ?>"><i class="ri ri-facebook" data-toggle="tooltip" data-placement="top" title="facebook"></i></a></li>
