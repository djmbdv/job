...
$stmt = $conn->prepare("INSERT INTO tbl_jobs (job_id, title, city, country, category, type, experience, description, responsibility, requirements, company, date_posted, closing_date, telefono)
 VALUES (:jobid, :title, :city, :country, :category, :type, :experience, :description, :responsibility, :requirements, :company, :dateposted, :closingdate, :telefono)");
